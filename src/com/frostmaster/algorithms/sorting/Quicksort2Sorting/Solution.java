package com.frostmaster.algorithms.sorting.Quicksort2Sorting;
...
public class Solution {
    ...
    static int partition(int ar[], int minpos, int maxpos)
    {
        ...
        int pos = leftlist.size()+minpos;
        ar[pos] = p;
        copy(rightlist,ar,pos+1);
    ...
    static void printArray(int[] ar,int start, int end) {
        for(int i = start; i <= end;i++) { System.out.print(ar[i]+" "); } System.out.println("");
    }
